                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{route('admin.category.update')}}" method="post"
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Category Slug" name="slugg"
                                                tabindex="0" value="{{$category->slugg}}" aria-required="true" required="">
                                        </fieldset>
    ...
    <script>
        $(function(){
            ...
            $("input[name='name']").on('change', function(){
                $("input[name='slugg']").val(stringToSlug($(this).val()));
            })
        })
